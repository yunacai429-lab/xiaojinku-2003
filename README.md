...
- 新增小猪存钱罐品牌 Logo，并应用于登录页、应用顶栏和浏览器图标
- 支持在 iPhone 和 Android 添加到主屏幕时显示专用 Logo
- 新增独立窗口运行模式，从手机主屏幕打开时更接近 App

### v1.6.1（2026-07-28）

- 修复手机记账页较长类别名称超出按钮边框的问题
- 类别按钮现在会随文字长度自适应，并在空间不足时自动换行
...
品牌 Logo 位于 `assets/logo.svg`，用于登录页、应用顶栏和浏览器图标。
